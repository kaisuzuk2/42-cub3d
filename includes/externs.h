...
void			init_horz_intercept(t_player *player, float ray_angle,
					t_ray_dir *dir, t_intercept *horz);
void			init_vert_intercept(t_player *player, float ray_angle,
					t_ray_dir *dir, t_intercept *vert);

// ray_dda.c
void			find_vert_hit(t_intercept *vert, t_ray_dir *dir, char **map,
					t_hit *hit);
void			find_horz_hit(t_intercept *horz, t_ray_dir *dir, char **map,
					t_hit *hit);
