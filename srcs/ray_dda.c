...
/*   Updated: 2026/01/26 09:47:13 by kaisuzuk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static t_bool	is_hit_horz_wall(t_intercept *horz, t_ray_dir *dir, char **map,
		t_hit *hit)
{
	float	x_check;
	float	y_check;
...
static t_bool	is_hit_vert_wall(t_intercept *vert, t_ray_dir *dir, char **map,
		t_hit *hit)
{
	float	x_check;
	float	y_check;
